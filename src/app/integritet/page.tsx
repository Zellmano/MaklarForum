  ...
  return (
    <article className="card max-w-4xl">
      ...
      <div className="mt-6 space-y-4 text-sm leading-6">
        ...
        <p>
          <strong>Dina rättigheter:</strong> du kan när som helst exportera all din data eller radera ditt konto direkt under <em>Min profil → Mina data &amp; integritet</em>. För rättelse av enskilda uppgifter, kontakta maklarforum@gmail.com.
        </p>
        <p>
